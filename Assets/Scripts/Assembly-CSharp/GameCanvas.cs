...
public class GameCanvas : IActionListener
{
    ...
    public void initGame()
    {
        ...
        {
            UnityEngine.Debug.LogError("errr: " + ex.StackTrace.ToString());
        }
    }
            ...
            if (Controller.isConnectionFail)
            {
                if (!Controller.isMain)
                {
                    if (currentScreen == serverScreen && ServerListScreen.isGetData && !Service.reciveFromMainSession)
                    {
                        ...
                        serverScreen.cancel();
                        //UnityEngine.Debug.Log("connect fail 1");
                    }
                    if (currentScreen == loginScr && !Service.reciveFromMainSession)
                    {
                        onConnectionFail();
                        //UnityEngine.Debug.Log("connect fail 2");
                    }
                }
                else
                {
                    ...
                    //UnityEngine.Debug.Log("connect fail 3");
                }
    ...
    public static void connect2()
    {
        ...
        {
            UnityEngine.Debug.LogError("IP2= " + GameMidlet.IP2 + " PORT 2= " + GameMidlet.PORT2);
    ...
    public static Image loadImage(string path)
    {
        ...
        {
            //UnityEngine.Debug.LogError("khong load duoc file: " + path);
        }
        return result;
    }
