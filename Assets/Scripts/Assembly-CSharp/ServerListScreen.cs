...
public class ServerListScreen : mScreen, IActionListener
{
    ...
    public static string smartPhoneVN = "Vũ trụ 1:dragon1.teamobi.com:14445:0:0:0," +
        ...
        "Naga:dragon.indonaga.com:14446:2:0:0,0,0";

    public static string javaVN = "Vũ trụ 1:112.213.94.23:14445:0:0:0," +
        "Vũ trụ 2:210.211.109.199:14445:0:0:0," +
        "Vũ trụ 3:112.213.85.88:14445:0:0:0," +
        "Vũ trụ 4:27.0.12.164:14445:0:0:0," +
        "Vũ trụ 5:27.0.12.16:14445:0:0:0," +
        "Vũ trụ 6:27.0.12.173:14445:0:0:0," +
        "Vũ trụ 7:112.213.94.223:14445:0:0:0," +
        "Vũ trụ 8:27.0.14.66:14446:0:0:0," +
        "Vũ trụ 9:27.0.14.66:14447:0:0:0," +
        "Vũ trụ 10:27.0.14.66:14445:0:0:0," +
        "Vũ trụ 11:112.213.85.35:14445:0:0:0," +
        "Võ đài liên vũ trụ:27.0.12.173:20000:0:0:0," +
    ...
    public override void update()
    {
        if (waitToLogin)
        {
            ...
            if (tWaitToLogin == 100)
            {
                ...
                Service.gI().finishUpdate("tWaitToLogin++;");
                waitToLogin = false;
            }
        }
        for (int i = 0; i < cmd.Length; i++)
    ...
    public override void switchToMe()
    {
        try
        {
            ...
            bigOk = true;
            string hehe = mResources.server + ": " + nameServer[ipSelect];
            cmd[2 + nCmdPlay].caption = hehe;
            center = new Command(string.Empty, this, cmd[selected].idAction, null);
