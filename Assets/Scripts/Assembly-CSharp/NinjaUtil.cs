...
public class NinjaUtil
{
    ...
    public static sbyte[] readByteArrayIcon(int num156, Message msg)
    {
        try
        {
    ...
    public static sbyte[] readByteImageByName(Message msg, string name)
    {
        try
        {
            int num = msg.reader().readInt();// data length
            if (num > 1)
            {
                sbyte[] data = new sbyte[num];
                msg.reader().read(ref data);
    ...
    public static sbyte[] readByteImageEff(Message msg, int id)
    {
        try
        {
            int num = msg.reader().readInt();
    ...
    public static sbyte[] readByteDataEff(Message msg, int id)
    {
        try
        {
            int num = msg.reader().readInt();
    ...
    public static sbyte[] readDataMob(Message msg, int id)
    {
        try
        {
            int num = msg.reader().readInt();
    ...
    public static sbyte[] readDataMobImage(Message msg, int id)
    {
        try
        {
            int num = msg.reader().readInt();
    ...
    public static sbyte[] readByteArrayNR_dart(myReader dos)
    {
        try
        {
            int num = dos.readInt();
            ...
            //string write = JsonConvert.SerializeObject((object)data);
    ...
    public static sbyte[] readByteArrayNR_arrow(myReader dos)
    {
        try
        {
            int num = dos.readInt();
    ...
    public static sbyte[] readByteArrayNR_effect(myReader dos)
    {
        try
        {
            int num = dos.readInt();
    ...
    public static sbyte[] readByteArrayNR_part(myReader dos)
    {
        try
        {
            int num = dos.readInt();
