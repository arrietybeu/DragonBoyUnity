        ...
        if (cmtoX >= wScroll - 10 && cmx >= wScroll - 10 && position == 0)
        {
            ...
            if (isChangeZone)
            {
                ...
                if (Char.myCharz().cHP > 0 && Char.myCharz().statusMe != 14)
                {
                    ...
                    if (type == 3)
                    {
                        Service.gI().requestChangeZone(selected);
                    }
                    else if (type == 14)
                    {
        ...
        try
        {
            for (int num22 = 1; num22 < currentListLength; num22++)
            {
                ...
                if (item3.itemOption != null)
                {
                    ...
                    {
                        if (item3.itemOption[num31].optionTemplate.id == 72)// cấp độ của item
                        {
                            text3 = " [+" + item3.itemOption[num31].param + "]";
                        }
                        if (item3.itemOption[num31].optionTemplate.id == 41)// chỉ số thưởng
                        {
                ...
                mFont4.drawString(g, item3.template.name + text3, num23 + 5, num24 + 1, 0);// draw Item name
                ...
                if (item3.itemOption != null)
                {
                    ...
                    {
                        mFont5 = mFont.tahoma_7_red;// item type ko bằng 5 thì draw màu này 
                    }
                    if (item3.itemOption.Length > 1)
                    {
                        for (int num32 = 1; num32 < 2; num32++)
                        {
                            if (item3.itemOption[num32] != null && item3.itemOption[num32].optionTemplate.id != 102
                ...
                SmallImage.drawSmallImage(g, item3.template.iconID, num26 + num28 / 2, num27 + num29 / 2, 0, 3);// draw id icon
                if (item3.itemOption != null)
                {
